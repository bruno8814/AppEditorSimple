...
![Java](https://img.shields.io/badge/Java-21-orange) ![JavaFX](https://img.shields.io/badge/JavaFX-21-blue) ![Status](https://img.shields.io/badge/Status-Terminado-green)
...
|:---:|:---:|
| ![Main](img/captura_main.png) | ![Progreso](img/captura_progreso.png) |

*(Asegúrate de poner tus imágenes en una carpeta llamada 'img' o borra esta tabla si no tienes fotos)*

---

## 📖 Manual de Uso Rápido

1. **Escribir:** Usa el área central para redactar. Los contadores inferiores se actualizarán solos.
2. **Dar Estilo:** Selecciona el texto y usa los botones de la barra superior (`Bold`, `Italic`, `Color`).
3. **Buscar:** Escribe en el campo "Buscar..." y pulsa `Siguiente` para navegar por las coincidencias.
4. **Guardar:** Pulsa `Exportar`. Aparecerá una ventana flotante indicando el progreso de la operación.
